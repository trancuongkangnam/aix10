...
const socials = [
  {
    ...
    href: 'https://www.facebook.com/trancuongkangnam/',
    label: 'Facebook',
  },
  {
    icon: (
    ...
    href: 'https://www.youtube.com/@trancuong-kangnam',
    label: 'YouTube',
  },
  {
    icon: (
    ...
    href: 'https://www.tiktok.com/@trancuongkangnam',
    label: 'TikTok',
  },
]
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm text-gray-400">
                ...
                <li className="flex gap-2">
                  ...
                  <a href="mailto:trancuongkangnam@gmail.com" className="hover:text-white break-all">trancuongkangnam@gmail.com</a>
                </li>
                <li className="flex gap-2">
                  <span style={{ color: '#c9a055' }}>🌐</span>
